...
- Use, modify, and redistribute the **code** under the terms of the AGPL.
- Truthfully state that your project is **"based on Forven"** or **"a fork of Forven,"** as long as you do not imply that it is the official Forven project or that it is endorsed by or affiliated with the Forven authors.

## What you may not do

- Use the **"Forven" name or logo** as the name of your fork, product, service, or organization.
- Use the name or logo in any way that suggests official status, endorsement, sponsorship, or affiliation.
