...
"""
from forven.scheduler import add_job, enable_job
...
def main() -> None:
    ...
    enable_job("forven-hypothesis-verdict-loop", enabled=True)
    ...
    enable_job("forven-hypothesis-promotion-loop", enabled=True)
    ...
    enable_job("forven-hypothesis-revisit-pass", enabled=True)
