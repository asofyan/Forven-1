...
export const SETTINGS_SUBSECTIONS: SettingsSubsection[] = [
  ...
  { id: 'trading-credentials-bn', area: 'trading', label: 'Binance credentials', description: 'API key, secret, and testnet toggle for Binance.' },
...
export const SETTINGS_MANIFEST: SettingsEntry[] = [
  ...
  // Exchange selection
  {
    ...
    description: 'Which exchange the bot connects to for market data and order placement.',
    usedBy: ['forven.api_core', 'forven.exchange.hyperliquid', 'forven.data_manager'],
    deepLinkTo: '/',
  },
  ...
  // Binance credentials
  {
    ...
    type: 'secret',
    area: 'trading',
    subsection: 'trading-credentials-bn',
    backendSection: 'binance',
    backendPath: 'api_key',
    description: 'API key used to authenticate REST requests to Binance.',
    usedBy: ['forven.api_core', 'forven.data_manager'],
  },
  {
    ...
    subsection: 'trading-credentials-bn',
    backendSection: 'binance',
    backendPath: 'api_secret',
    description: 'Secret used to sign Binance API requests.',
    usedBy: ['forven.api_core', 'forven.data_manager'],
  },
  {
    ...
    subsection: 'trading-credentials-bn',
    backendSection: 'binance',
    backendPath: 'use_testnet',
    description: 'Send Binance orders to the testnet endpoint so live mode stays sandboxed.',
    usedBy: ['forven.api_core', 'forven.data_manager'],
  },
