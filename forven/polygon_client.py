...
from forven.config import get_polygon_api_key, redact_api_key
from forven.rate_limiter import RateLimiter
from forven.symbol_mapping import AssetClass, detect_asset_class, timeframe_to_polygon, to_polygon

log = logging.getLogger("forven.polygon")
...
class PolygonClient:
    ...
    def fetch_aggs(
        ...
        *,
        ...
        Args:
            symbol: Forven canonical symbol (AAPL, BTC-USDT, EUR-USD, etc.)
            timeframe: Forven timeframe (1m, 5m, 1h, 4h, 1d, etc.)
