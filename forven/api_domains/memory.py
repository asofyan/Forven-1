...
from forven.vectordb import search_narratives as _search_narratives_sync
...
def _chroma_dir() -> Path:
    return Path(getattr(cfg, "FORVEN_HOME", Path.home() / ".forven")) / "chromadb"
...
def _chroma_health(limit: int = 6) -> dict[str, Any]:
    ...
    if _in_process_chroma_disabled():
        # The vector layer is off on this host (FORVEN_DISABLE_CHROMA_IN_PROCESS,
        ...
        return {
            ...
            "summary": "Vector memory disabled on this host (FORVEN_DISABLE_CHROMA_IN_PROCESS)",
            "count": 0,
            "collections": [],
