...
from forven.lab_strategy_pool import (
    LAB_STRATEGY_SOURCE_REGISTRY,
    list_strategy_pool_candidates,
    normalize_strategy_sources,
)
from forven.strategies.backtest import backtest_strategy, expand_strategy_trade_modes, validate_backtest_risk_controls
from forven.strategies.base import BaseStrategy
from forven.strategies.registry import discover, get_all
...
log = logging.getLogger("forven.lab_matrix_engine")
...
def _disable_backtest_production_persistence():
    import forven.strategies.backtest as backtest_module
...
def _create_champion_approval(
    *,
    ...
    from forven.db import create_approval, log_activity
