...
Maps between Forven canonical format and provider-specific formats
...
def from_polygon(ticker: str) -> tuple[str, AssetClass]:
    """Convert Polygon.io ticker to canonical Forven format + asset class.
...
def timeframe_to_polygon(timeframe: str) -> tuple[int, str]:
    """Convert Forven timeframe to Polygon multiplier + timespan.
