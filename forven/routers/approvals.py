...
from forven.control_plane import approval_modes as control_plane_approval_modes
from forven.control_plane.models import ApprovalDecisionBody, ApprovalHandoffBody, ApprovalTroubleshootBody
from forven.control_plane.smart_approval import classify_approval
...
def classify_approval_route(approval_id: int) -> dict[str, Any]:
    ...
    from forven.db import get_approval as db_get_approval
