...
def test_mark_crucible_viable_requires_evidence_id(forven_db):
    h = _hyp()
...
def test_proven_verdict_never_leaves_evidence_ref_null(forven_db):
    ...
    with patch("forven.hypothesis_verdict._call_llm", return_value=json.dumps({"verdict": "proven", "rationale": "r"})):
